...
/*发送部分*/
uint8_t NRF24L01_TxAddress[5] = {0x00, 0x00, 0x00, 0x00, 0x00};		//发送地址，固定5字节
#define NRF24L01_TX_PACKET_WIDTH		4							//发送数据包宽度，范围：1~32字节
uint8_t NRF24L01_TxPacket[NRF24L01_TX_PACKET_WIDTH];				//发送数据包

/*接收部分*/
uint8_t NRF24L01_RxAddress[5] = {0x00, 0x00, 0x00, 0x00, 0x00};		//接收通道0地址，固定5字节
...
{
	/*取MISO引脚的高低电平并返回*/
	return HAL_GPIO_ReadPin(GPIOE, SPI_MISO_Pin);
}
