...
Vofa_HandleTypedef vofa_inst_binding_uart3;

uint32_t tim7_10ms_cnt = 0u;   // �??1比较
uint32_t tim7_1000ms_cnt = 0u; // �??100比较
float Angle_init;
...
// int32_t compare_dir = 0;
// int32_t command = 0;
// uint8_t dbg_datarev_buff[32] = {0};
...
static void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, Motor_D10_Pin|GPIO_PIN_11|Motor_D12_Pin|Motor_D3_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, LED_G_PIN_Pin|LED_R_PIN_Pin|LED_B_PIN_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pin : Motor_D10_Pin */
  GPIO_InitStruct.Pin = Motor_D10_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Motor_D10_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : Motor_A8_Pin */
  GPIO_InitStruct.Pin = Motor_A8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(Motor_A8_GPIO_Port, &GPIO_InitStruct);
