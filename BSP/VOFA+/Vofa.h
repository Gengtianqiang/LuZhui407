...
#define VOFA_TXBUFFER_SIZE 300		// Send/Receive data buffer length
#define VOFA_RXBUFFER_SIZE 100		// Send/Receive data buffer length
...
typedef struct
{
	uint8_t buffer[VOFA_RXBUFFER_SIZE];	//Data buffer
...
typedef struct
{
	uint8_t txBuffer[VOFA_TXBUFFER_SIZE];
